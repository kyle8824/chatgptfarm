...
let s=await snap();
if(s.version!=='phaser-v1.6.3-embodiment')failures.push(`wrong renderer: ${s.version}`);
...
if(!(await page.locator('#phInspectBody').innerText()).includes('Memories'))failures.push('inspector lost persistent memory information');
