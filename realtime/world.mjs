...
export class RealtimeController{
 ...
 geometry(){const w=this.record.world;return {bounds:w.worldModel.bounds,frontier:frontierFrame(w),objects:w.worldModel.objects.filter(o=>o.position).map(o=>({id:o.id,type:o.type,position:o.position,geometry:o.geometry,state:o.state})),sites:Object.values(w.regions?.sites||{}).map(s=>({id:s.id,position:s.position,label:s.label})),surfaceHistory:w.surfaceHistory,groundWear:Object.values(w.liveGround?.cells||{})};}
}
