...
The workshop now includes black bear, eastern cottontail and representative creek fish studies. These use the same shared factories as the live world. Balanced budgets: bear 9,708 triangles / 13 meshes; rabbit 8,168 / 9; fish 1,504 / 3. The larger mixed-group setting contains 14 models. Wildlife behavior is server-owned in the world; workshop poses are controlled animation.
